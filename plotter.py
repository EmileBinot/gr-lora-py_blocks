...
loraFrameBEF = np.fromfile(open("/home/ebinot/Documents/gr-lora-py_blocks/lora_frameBEF"), dtype=np.complex64)
...
axs[0].specgram(loraFrameBEF, NFFT=64, Fs=32, noverlap=8)
