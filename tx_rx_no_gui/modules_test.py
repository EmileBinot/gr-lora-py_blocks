...
import time
import modules_test_epy_block_0_0 as epy_block_0_0  # embedded python block
import modules_test_epy_block_0_1_0_0 as epy_block_0_1_0_0  # embedded python block
import modules_test_epy_block_12_0 as epy_block_12_0  # embedded python block
...
import modules_test_epy_block_2_0 as epy_block_2_0  # embedded python block
import modules_test_epy_block_3 as epy_block_3  # embedded python block
import modules_test_epy_block_5_0 as epy_block_5_0  # embedded python block
import modules_test_epy_block_6 as epy_block_6  # embedded python block
import modules_test_epy_block_6_0_0_0 as epy_block_6_0_0_0  # embedded python block
import modules_test_epy_block_6_0_0_0_0_0 as epy_block_6_0_0_0_0_0  # embedded python block
import modules_test_epy_block_6_0_1_0 as epy_block_6_0_1_0  # embedded python block
import modules_test_epy_block_6_0_2 as epy_block_6_0_2  # embedded python block
...
import modules_test_epy_block_8_0_0 as epy_block_8_0_0  # embedded python block
import modules_test_epy_block_9_0_0 as epy_block_9_0_0  # embedded python block
import modules_test_epy_block_9_0_0_0_0 as epy_block_9_0_0_0_0  # embedded python block
import modules_test_epy_block_9_1 as epy_block_9_1  # embedded python block
...
class modules_test(gr.top_block):
    ...
    def __init__(self):
        ...
        self.epy_block_9_1 = epy_block_9_1.blk(preamble_nitems=preamble_nitems*os_factor, payload_nitems=payload_nitems*os_factor, threshold=0.1)
        self.epy_block_9_0_0_0_0 = epy_block_9_0_0_0_0.blk(preamble_len=preamble_len, payload_nitems=payload_nitems, threshold=int(5e4), SF=9)
        self.epy_block_9_0_0 = epy_block_9_0_0.blk(preamble_len=preamble_len, payload_nitems=payload_nitems, threshold=int(50e3), SF=9)
        self.epy_block_8_0_0 = epy_block_8_0_0.blk(SF=9)
        ...
        self.epy_block_6_0_2 = epy_block_6_0_2.my_basic_adder_block(tag_name="payload_begin")
        self.epy_block_6_0_1_0 = epy_block_6_0_1_0.my_basic_adder_block(tag_name="preamble_begin")
        self.epy_block_6_0_0_0_0_0 = epy_block_6_0_0_0_0_0.Modulation(SF=SF)
        self.epy_block_6_0_0_0 = epy_block_6_0_0_0.my_basic_adder_block(tag_name="threshold_exceeded")
        self.epy_block_6 = epy_block_6.blk(preamble_nitems=4224, payload_nitems=8192)
        self.epy_block_5_0 = epy_block_5_0.Demodulation(SF=SF, B=250000, os_factor=os_factor)
        self.epy_block_3 = epy_block_3.PreambleGenerator(SF=SF, preamble_len=preamble_len)
        self.epy_block_2_0 = epy_block_2_0.LoraDewhitening(reset_key="payload_begin")
        self.epy_block_1_1 = epy_block_1_1.HammingTx(CR=CR)
        self.epy_block_1_0_0 = epy_block_1_0_0.Whitening(reset_key="tx_sob")
        self.epy_block_1_0 = epy_block_1_0.HammingRx(CR=CR, payload_len=payload_len)
        self.epy_block_12_0 = epy_block_12_0.blk()
        self.epy_block_0_1_0_0 = epy_block_0_1_0_0.Interleaver(SF=SF, CR=CR)
        self.epy_block_0_0 = epy_block_0_0.Deinterleaver(SF=SF, CR=CR)
        ...
        self.blocks_tagged_stream_align_1_2 = blocks.tagged_stream_align(gr.sizeof_gr_complex*1, "payload_begin")
        self.blocks_tagged_stream_align_1_1_0 = blocks.tagged_stream_align(gr.sizeof_gr_complex*1, "preamble_begin")
        self.blocks_tagged_stream_align_1_0_0 = blocks.tagged_stream_align(gr.sizeof_gr_complex*1, "threshold_exceeded")
        ...
        self.blocks_stream_to_vector_0_0 = blocks.stream_to_vector(gr.sizeof_gr_complex*1, pow(2,SF)*os_factor)
        self.blocks_null_sink_1 = blocks.null_sink(gr.sizeof_gr_complex*1)
        self.blocks_null_sink_0_0 = blocks.null_sink(gr.sizeof_char*1)
        self.blocks_msgpair_to_var_0_0_0_0_0 = blocks.msg_pair_to_var(self.set_h_est)
        self.blocks_msgpair_to_var_0_0 = blocks.msg_pair_to_var(self.set_success_rate)
        ...
        self.msg_connect((self.epy_block_12_0, 'h_est'), (self.blocks_msgpair_to_var_0_0_0_0_0, 'inpair'))
        self.msg_connect((self.epy_block_1_0, 'msg_out'), (self.blocks_msgpair_to_var_0_0, 'inpair'))
        self.msg_connect((self.pdu_random_pdu_0, 'pdus'), (self.pdu_pdu_to_stream_x_0, 'pdus'))
        self.connect((self.blocks_stream_to_vector_0_0, 0), (self.epy_block_5_0, 0))
        ...
        self.connect((self.blocks_tagged_stream_align_1_0_0, 0), (self.epy_block_6_0_0_0, 0))
        self.connect((self.blocks_tagged_stream_align_1_1_0, 0), (self.epy_block_6_0_1_0, 0))
        self.connect((self.blocks_tagged_stream_align_1_2, 0), (self.epy_block_6_0_2, 0))
        ...
        self.connect((self.epy_block_12_0, 0), (self.blocks_null_sink_1, 0))
        ...
        self.connect((self.epy_block_2_0, 0), (self.blocks_null_sink_0_0, 0))
        self.connect((self.epy_block_3, 0), (self.epy_block_6, 0))
        self.connect((self.epy_block_5_0, 0), (self.epy_block_8_0_0, 0))
        self.connect((self.epy_block_6, 0), (self.blocks_vector_to_stream_0, 0))
        self.connect((self.epy_block_6_0_0_0, 0), (self.epy_block_9_0_0, 0))
        self.connect((self.epy_block_6_0_0_0, 0), (self.epy_block_9_0_0_0_0, 0))
        self.connect((self.epy_block_6_0_0_0_0_0, 0), (self.blocks_vector_to_stream_1, 0))
        self.connect((self.epy_block_6_0_1_0, 0), (self.epy_block_12_0, 0))
        self.connect((self.epy_block_6_0_2, 0), (self.blocks_stream_to_vector_0_0, 0))
        self.connect((self.epy_block_7_0, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.epy_block_8, 0), (self.epy_block_6_0_0_0_0_0, 0))
        self.connect((self.epy_block_8_0_0, 0), (self.epy_block_0_0, 0))
        self.connect((self.epy_block_9_0_0, 0), (self.blocks_tagged_stream_align_1_2, 0))
        self.connect((self.epy_block_9_0_0_0_0, 0), (self.blocks_tagged_stream_align_1_1_0, 0))
        self.connect((self.epy_block_9_1, 0), (self.blocks_tagged_stream_align_1_0_0, 0))
        self.connect((self.pdu_pdu_to_stream_x_0, 0), (self.epy_block_1_0_0, 0))
        self.connect((self.uhd_usrp_source_1, 0), (self.epy_block_9_1, 0))
    ...
    def set_payload_len(self, payload_len):
        ...
        self.epy_block_1_0.payload_len = self.payload_len
    ...
    def set_CR(self, CR):
        self.CR = CR
        self.set_payload_nsymb(int((self.payload_len/self.SF)*(self.CR+4)))
        self.epy_block_0_0.CR = self.CR
        self.epy_block_0_1_0_0.CR = self.CR
        self.epy_block_1_0.CR = self.CR
    ...
    def set_preamble_len(self, preamble_len):
        ...
        self.epy_block_9_0_0_0_0.preamble_len = self.preamble_len
    ...
    def set_preamble_nitems(self, preamble_nitems):
        ...
        self.epy_block_9_1.preamble_nitems = self.preamble_nitems*self.os_factor
    ...
    def set_payload_nitems(self, payload_nitems):
        ...
        self.epy_block_9_0_0_0_0.payload_nitems = self.payload_nitems
        self.epy_block_9_1.payload_nitems = self.payload_nitems*self.os_factor
    ...
    def set_os_factor(self, os_factor):
        ...
        self.epy_block_5_0.os_factor = self.os_factor
        self.epy_block_9_1.payload_nitems = self.payload_nitems*self.os_factor
        self.epy_block_9_1.preamble_nitems = self.preamble_nitems*self.os_factor
